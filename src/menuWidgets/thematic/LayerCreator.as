package menuWidgets.thematic
{
	...
	public class LayerCreator
	{
		...
		private static function createFeatureLayer(layerCreationProperties:LayerCreationProperties):FeatureLayer
		{
			...
			//添加自定义聚类样式
			//		var wCluster:WeightedClusterer = new WeightedClusterer();
			//		wCluster.symbol = new ImageFlareSymbol();
			//		featureLayer.clusterer = wCluster;
		...
		private static function createImageLayer(layerCreationProperties:LayerCreationProperties):ArcGISImageServiceLayer
		{
			...
			imgLayer.noData = layerCreationProperties.noData.toString();
		...
		private static function createWebTiledLayer(layerCreationProperties:LayerCreationProperties):WebTiledLayer
		{
